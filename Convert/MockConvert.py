...
def Mags_to_distance(absmag, appmag, Coef_extinction, Dist_min, Dist_max, ll, bb):
    import numpy as np
    from dustmaps.bayestar import BayestarQuery
    bayestar = BayestarQuery(version='bayestar2019')
    from astropy.coordinates import SkyCoord
    import astropy.units as units
    mock_dist = np.linspace(Dist_min, Dist_max, 100001)
    ...
    return mock_dist[ind_min], mock_absmag[ind_min]